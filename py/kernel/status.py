...
ERR_UNKNOWN_TASK               = 10
ERR_INCORRECT_PERFORMER_OUTPUT = 11
...
MSG_APP_INIT_FAILED            = "Failed to initialize the application. Perhaps, a database in unavailable"
MSG_UNKNOWN_REQUEST_TYPE       = "Unknown request type"
MSG_UNKNOWN_PERFORMER          = "Unknown performer"
MSG_UNKNOWN_TASK               = "Unknown task" 
MSG_INCORRECT_PERFORMER_OUTPUT = "Incorrect performer output" 
MSG_SERIALIZATION_FAILURE      = "Serialization failure"