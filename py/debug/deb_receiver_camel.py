    ...
    return \
        """{"measurements": [
                ...
                }, 
                {
                    ...
                    "acceptedAt": "2023-01-17 11:39:24.436 UTC+02", 
                    "sensorId": "default-webhelp-sensor", 
                    "args": [
                        {"varName": "icap.cms.doc.uid", "parsableValue": "193"}, 
                        {"varName": "icap.cms.doc.verno", "parsableValue": "22"}, 
                ...
                }, 
                {
                    ...
                    "acceptedAt": "2023-01-17 11:39:24.437 UTC+02", 
                    "sensorId": "default-webhelp-sensor", 
                    "args": [
                        {"varName": "icap.pagereadId", "parsableValue": "2ce2a741-919a-47a1-9a3a-c05719bde44b"}, 
                        {"varName": "icap.action.code", "parsableValue": "LOAD"}, 
                        {"varName": "icap.action.timeOffset", "parsableValue": 3}], 
                    "outs": []
                }
            ]
        }"""
